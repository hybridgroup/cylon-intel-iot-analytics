 ...
 * @public
 */
Adaptor.prototype.addComponent = function(accountId, dId, component, userCb) {
  var route = "/accounts/" + accountId + "/devices/" + dId + "/components";

  this._postJson(route, component, userCb);
};
