 ...
 * @private
 */
Adaptor.prototype._rest = function(verb, path, data, query, userCb, token) {
  ...
  switch(verb) {
    ...
    case "putJson":
      rest[verb].call(null, params.url, data, params.options)
        .on("complete", this._defCb(userCb));
      break;
    default:
...
Adaptor.prototype._postJson = function(path, data, userCb, token) {
  this._rest("postJson", path, data, null, userCb, token);
};
...
Adaptor.prototype._putJson = function(path, data, userCb) {
  this._rest("putJson", path, data, null, userCb);
};
...
Adaptor.prototype._del = function(path, data, query, userCb) {
  this._rest("del", path, data, query, userCb);
};
...
Adaptor.prototype.updateDevice = function(accountId, deviceId, device, userCb) {
  ...
  this._putJson(route, device, userCb);
};
